...
"""
  A simple wrapper around a pycassa.ConnectionPool object that provides easy
  access and caching for ColumnFamily objects.
...
class CassandraConnection():
    ...
    def __str__(self):
        return '<toto.cassandraconnection.CassandraConnection %d [%s]>' % (
            id(self), ','.join(self.column_families.keys()))
